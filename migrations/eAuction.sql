...
-- Functions
--
CREATE DEFINER=`blk`@`%` FUNCTION `LEVENSHTEIN` (`s1` VARCHAR(255), `s2` VARCHAR(255)) RETURNS INT(11) DETERMINISTIC BEGIN
...
(8, 'radish', 500.00, '2025-01-05 13:57:00', '2025-01-09 13:57:00', 'prod_677a8fc1d902c.webp', 'organic', 120.0000, 'kg', 'Udumalipettai, Tiruppur,Tamil Nadu,Indian-642205', 'radish Radish ', 3, 1, 'activate', '2025-01-05 13:57:21'),
...
(10, 'Radishs', 5478.00, '2025-01-06 06:13:00', '2025-01-06 10:13:00', 'prod_677b74dd644b8.webp', 'organic', 12.0000, 'kg', 'Udumalipettai, Tiruppur,Tamil Nadu,Indian-642205', 'Tj', 3, 1, 'activate', '2025-01-06 06:14:53');
...
(1, 'Welcome to eAuction78', 'hero_677522e35a761.webp', 'Join our online auction platform!', '<p>eAuction is an online platform where farmers and buyers can participate in live auctions of agricultural products. It ensures transparent bidding and fair market prices.</p>', 'activate', '2024-12-29 14:01:33'),
